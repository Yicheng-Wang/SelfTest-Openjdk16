...
private:
  ...
  HeapWord* allocate_inside_tlab_slow(Allocation& allocation,int alloc_gen) const;
  HeapWord* allocate_inside_tklab_slow(Allocation& allocation,int alloc_gen) const;
